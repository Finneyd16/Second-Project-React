    ...
    <>
      ...
      <div className="py-5 no">
        <div className="row pdiv3">
          ...
          <div
            style={{ color: "#81AFDD" }}
            className="future3 d-flex flex-column col-sm-12 col-md-4 col-lg-4 "
          >
            <p className="mb-4" style={{ width: "95%" }}>
      ...
      <div className="page4 py-5 my-5 d-flex px-5 mx-4">
        <div className="">
          <img src={P9} alt="" />
        </div>

        <div className="p9div ">
          <p style={{ color: "#71E5FF", fontSize: "80%" }}>
            Request Early Access to Get Started
          </p>
          <h4
            style={{
